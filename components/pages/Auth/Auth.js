        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 h-screen">
            <div className="col-span-1 hidden lg:flex">
                <div className="h-screen w-full">
                    <img alt="auth_image" src="/img/resources/login/desktop.png" className="object-cover w-full h-full" />
                </div>
            </div>
            <div className="col-span-1">
                <div className="h-screen w-full relative block lg:flex lg:items-center lg:justify-center">
                    <div className="h-1/2 lg:hidden w-full">
                        <img alt="auth_image_2" src="/img/resources/login/mobile.png" className="object-cover w-full h-full" />
                    </div>
                    <div className="h-1/2 flex items-start lg:items-center justify-start lg:w-[500px] mx-auto p-4">
                        <div className="space-y-6 lg:space-y-12">
                            <div>
                                <img alt="auth_image_3" src="/img/logos/logo-edify-color.png" className="w-24" />
                            </div>
                            <div>
